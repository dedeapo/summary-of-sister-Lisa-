...
trained on the CelebA dataset for 10 epochs.
...
""")
    ...
    def complete(self, config):
        ...
        if config.maskType == 'random':
            ...
            mask[l:u, l:u, :] = 0.0# zuoyanjing
        #   mask[l+10:u+10, l:u, :] = 0.0 #zuiba
            ...
            for i in xrange(config.nIter):
                ...
                if i % config.outInterval == 0:
                    ...
                    if lowres_mask.any():
                        ...
                        save_images(np.repeat(np.repeat(lowres_G_imgs[:batchSz,:,:,:], [nRows,nCols],
                                              self.lowres, 1), self.lowres, 2), imgName)
    ...
    def generator(self, z):
        with tf.variable_scope("generator") as scope:
            ...
            depth_mul = 4  # Depth decreases as spatial component increases.＃随着空间分量增加，深度减小。
